...
class CustomPostTypeController extends BaseController
{
    ...
    public function setSettings(){
        $args = array(
          array(
            'option_group' => 'ariansani_plugin_cpt_settings',
            'option_name' => 'ariansani_plugin_cpt',
	...
	{
        $options = get_option('ariansani_plugin_cpt');
